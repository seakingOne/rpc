...
import com.ynhuang.netty.proxy.RpcClientFactoryBean;
...
public class RpcInitConfig implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry registry) {
        ...
        //设置扫描器
        provider.addIncludeFilter(new AnnotationTypeFilter(MyRpcClient.class));

        //扫描此包下的所有带有@RpcClient的注解的类
        Set<BeanDefinition> beanDefinitionSet = provider.findCandidateComponents("com.ynhuang.netty");
        ...
        for (BeanDefinition beanDefinition : beanDefinitionSet) {
            ...
            if (beanDefinition instanceof AnnotatedBeanDefinition) {
                ...
                Map<String, Object> paraMap = annotatedBeanDefinition.getMetadata()
                        .getAnnotationAttributes(MyRpcClient.class.getCanonicalName());
