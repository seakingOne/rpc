...
import com.ynhuang.netty.config.ServerConfig;
...
public class ServerHandler extends SimpleChannelInboundHandler {
    ...
    private Map<String, Object> rpcAnnnotClass = ServerConfig.getRpcAnnnotClass();
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        log.info("service对象为: {}", ServerConfig.getRpcAnnnotClass());
